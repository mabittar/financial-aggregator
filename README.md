...
- [x] Ingest JSON no Go Ledger Core (S3)
- [x] Migrações golang-migrate
- [x] Market Data no Python Worker (Pydantic v2) (S6)
- [x] Consolidação + reconciliação
- [x] Dashboard consolidado JWT
- [x] XIRR auto-cálculo
